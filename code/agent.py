...
def run_agent(pod_name, namespace):
    ...
    #     '{"owner":"sarabanderby","repo":"etx-agentic-ai",'
    ...
    try:
        ...
        fallback_prompt = (
            ...
            "Then create a Github issue with owner 'sarabanderby', repo 'etx-agentic-ai', "
